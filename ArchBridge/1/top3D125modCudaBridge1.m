...
filename = strcat('ArchBridge1_',num2str(nl),'_', num2str(nelx),'_', num2str(nely),'_', num2str(nelz),'_',num2str(rmin),'caml','.txt');    
...
pasV=elmNrs(1:nely,1:nelz-2,nelx/2-1:nelx/2+1);
